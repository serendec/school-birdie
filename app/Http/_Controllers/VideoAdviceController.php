...
class VideoAdviceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Validator::make($request->all(), [
            ...
            'video'    => ['array', 'max:10'],
            // 'video.*'  => ['required', 'mimes:mp4,mov,3gp,av', 'max:30720'],
        ...
        return redirect()->route('video_advice.show', $videoAdvice->id)->with([
            'result' => 'success',
    ...
    public function show(Request $request)
    {
        ...
        return view('video_advice.show', compact('videoAdvice', 'videos', 'unreadCommentIds'));
    }
