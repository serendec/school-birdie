...
return [
    ...
    */
    ...
    'confirmed' => ':attributeと確認欄が一致していません。',
    ...
    */
    ...
    'custom' => [
        ...
        'family_name_kana' => [
            'required' => 'しめい（せい）を入力してください。',
        ],
        'first_name_kana' => [
            'required' => 'しめい（めい）を入力してください。',
        ],
        'category_id' => [
        ...
        'video_advice_available' => [
            'required' => '動画添削の利用を選択してください。',
        ],
        'forum_available' => [
            'required' => 'フォーラムの利用を選択してください。',
        ],
        'lesson_plan_id' => [
            'required' => '受講プランを選択してください。',
        ],
    ],
